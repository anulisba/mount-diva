            ...
            <footer className="site-footer">
                <div className="footer-content">
                    <div className="footer-main">
                        <div className="footer-brand">
                            <div className="footer-logo">
                                <img src={logo} alt="Mount Diva Technical Services" />
                            </div>
                            <p className="brand-description">
                                Mount Diva Technical Services L.L.C is a UAE-based company providing a complete range of services, including MEP, civil, and annual maintenance contracts. We are committed to quality, efficiency, and customer satisfaction.
                            </p>
                            <div className="social-icons">
                                {/* The PDF does not contain social media links. You may want to update these with the actual links. */}
                                ...
                                <a href="https://wa.me/971588188566" className="social-link">
                                ...
                                <ul className="contact-list">
                                    <li className="contact-item">
                                        ...
                                        <div>
                                            ...
                                            <span className="contact-value">info@mountdiva.com</span>
                                        </div>
                                    </li>
                                    <li className="contact-item">
                                        <svg className="contact-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                        ...
                                        <div>
                                            ...
                                            <span className="contact-value">Tel: +971 42685661</span>
                    ...
                    <div className="footer-bottom">
                        <p className="copyright">&copy; {new Date().getFullYear()} Mount Diva Technical Services L.L.C. All rights reserved. | <a href="https://www.mountdiva.com" target="_blank" rel="noopener noreferrer">www.mountdiva.com</a></p>
                    </div>
                </div>
